...
class DiretorTurmaController extends Controller
{
    ...
    //     DB::transaction(function () use ($turmaId, $schoolId, $anoLetivo, $request) {
    //         // remove todos diretores antigos da turma no ano vigente
    //         DiretorTurma::where('turma_id', $turmaId)
    //             ->where('school_id', $schoolId)
    //             ->where('ano_letivo', $anoLetivo)
    //             ->delete();
    ...
    //     return redirect()->route('escola.lotacao.diretor_turma.index')
    //         ->with('success', '✅ Diretores atualizados com sucesso!');
    // }
